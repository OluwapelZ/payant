module.exports = {
    INVALID_AUTH_PROVIDER_NAME: 'Auth Provider must be set to Payant for access through this microservice',
    TRANSACTION_SUCCESSFUL: 'Transaction Processed Successfully',
    QUERY_REQUEST_SUCCESSFUL: 'Query completed successfully',
